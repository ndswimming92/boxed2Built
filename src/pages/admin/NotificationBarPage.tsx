  ...
  return (
    <div className="max-w-4xl px-0">
      <div className="mb-6 sm:mb-8">
        <h1 className="text-2xl sm:text-3xl font-bold text-slate-900 mb-1 sm:mb-2">Notification Bar</h1>
        <p className="text-sm sm:text-base text-slate-600">Manage site-wide announcements and special messages</p>
      </div>

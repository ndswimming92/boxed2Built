              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-center">
                {SERVICE_LOCATIONS.map((location) => (
                  <Link
                    ...
                    className="bg-gray-50 rounded-lg shadow p-4 text-gray-700 hover:text-blue-800 hover:shadow-md font-medium transition-all"
                  >
        ...
        <section className="py-20 bg-gradient-to-br from-blue-700 to-blue-900 text-white">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <BookingTextLink pageSection="tv_mounting_cta" tone="light" className="mt-6" />
            </div>
          </div>
        </section>
      </main>

            ...
            <div className="p-6">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="text-center p-3 bg-green-50 rounded-lg">
                  ...
                  <div className="text-xl font-bold text-green-700">$185+</div>
                </div>
                <div className="text-center p-3 bg-purple-50 rounded-lg">
                  <div className="text-sm text-gray-600 mb-1">Dressers</div>
                  <div className="text-xl font-bold text-purple-700">$320+</div>
                </div>
                <div className="text-center p-3 bg-amber-50 rounded-lg">
                  <div className="text-sm text-gray-600 mb-1">Beds</div>
                  <div className="text-xl font-bold text-amber-700">$295+</div>
                </div>
              </div>
              <div className="text-center mt-4">

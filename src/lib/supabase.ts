...
const COLS = {
  ...
  service:
    'id,business_id,name,description,category,base_price,min_price,max_price,price_range_description,price_currency,duration_minutes,is_featured,display_order,is_active,created_at,updated_at',
  hours:

...
export const usePageMeta = (config: PageMetaConfig) => {
  const { title, description, canonicalUrl, ogTitle, ogDescription, twitterTitle, twitterDescription } = config;

  useEffect(() => {
    setPageMeta({ title, description, canonicalUrl, ogTitle, ogDescription, twitterTitle, twitterDescription });
  }, [title, description, canonicalUrl, ogTitle, ogDescription, twitterTitle, twitterDescription]);
};

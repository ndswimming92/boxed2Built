...
3. **qr_scans**: Analytics and tracking data
   ...
   - Device info: `user_agent`, `device_type`, `browser`, `os`
   - Location: `ip_address`, `country`, `city`
   - Marketing: `referrer`, `utm_source`, `utm_medium`, `utm_campaign`
...
6. Logs scan data (device, browser, location, UTM params)

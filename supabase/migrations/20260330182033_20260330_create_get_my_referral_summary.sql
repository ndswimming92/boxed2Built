/*
  # Create get_my_referral_summary function

  ## Summary
  This function was defined in a migration file but never applied to the database.
  It exposes the logged-in portal customer's referral code and credit balances by
  matching their customer record to the corresponding client record.
*/

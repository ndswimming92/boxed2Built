/*
  # Fix client metrics to use correct completion date column

  ## Overview
  Updates the update_client_metrics function to use date_completed instead of completion_date.

  ## Changes
  - Changes completion_date to date_completed
*/
...
BEGIN
  ...
  -- Get last job completion date (using date_completed)

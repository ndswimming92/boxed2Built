    ...
    <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
      ...
      <tr><td style="background:#ffffff;padding:32px;">
        ...
        <div style="background:#f0f7ff;border:1px solid #bfdbfe;border-radius:8px;padding:20px;margin-bottom:24px;">
          ...
          <p style="margin:0;font-size:28px;font-weight:800;color:#1e3a5f;font-family:monospace;letter-spacing:2px;">${p.confirmationCode}</p>
          <p style="margin:6px 0 0;color:#6b7280;font-size:12px;">Keep this handy — you can use it to look up your request at any time.</p>
        </div>
        ...
        <p style="margin:0 0 8px;color:#374151;font-size:15px;line-height:1.7;">We'll review your request and reach out within <strong>24 hours</strong> to confirm scheduling and finalize your quote.</p>
        <p style="margin:0 0 24px;color:#374151;font-size:15px;line-height:1.7;">Questions in the meantime? Call or text us at <a href="tel:+16154034538" style="color:#1d4ed8;">(615) 403-4538</a>.</p>
